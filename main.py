...
train_dataset = FrameDataset(root_dir='UCF101_subset/train', transform=transform)
train_dataloader = DataLoader(train_dataset, batch_size=4, shuffle=True, num_workers=2)

test_dataset = FrameDataset(root_dir='UCF101_subset/test', transform=transform)
test_dataloader = DataLoader(test_dataset, batch_size=4, shuffle=False, num_workers=2)

val_dataset = FrameDataset(root_dir='UCF101_subset/val', transform=transform)
